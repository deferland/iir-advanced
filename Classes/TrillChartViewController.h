//
// File:	   TrillChartViewController.h
//
...
@interface TrillChartViewController : UIViewController <UIScrollViewDelegate>
{
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil instrument:(Instrument *)instrument note:(NSInteger)noteIndex;
