...
@implementation FileResourceViewController
...
- (void) viewWillAppear: (BOOL) animated {
	...
	if (searchable) {
      NSError *error;
		[self.searchHandler setSearchableContent: [NSString stringWithContentsOfFile: self.fileMenuItem.path encoding: NSASCIIStringEncoding error: &error] baseURL: self.baseURL];
	} else {
